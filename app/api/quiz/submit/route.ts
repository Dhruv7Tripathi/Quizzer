...
//   request: NextRequest,
//   context: { params: { id: string } } // ✅ Fix: Ensure params are extracted correctly
// ) {
//   try {
//     const { params } = context; // ✅ Fix: Correctly access params
//     console.log("Received params:", params); // Debugging

//     if (!params?.id) {
//       return NextResponse.json(
//         { error: "Quiz ID is missing in URL" },
//         { status: 400 }
//       );
//     }
...
//     console.log("Received answers:", answers); // Debugging
...
//     const quiz = await prisma.quiz.findUnique({
//       where: {
//         id: params.id, // ✅ Fix: Ensure `params.id` is accessed correctly
//       },
//       include: {
//         questions: {
//           orderBy: {
